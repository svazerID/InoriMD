...
const fcon = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': `© ALFIJMK48`,}}}
...
handler.help = ['bcgctag']
handler.tags = ['owner']
handler.command = /^(broadcastgctag|bcgctag)$/i
